...
audioset_train_json=./16k/train.json
audioset_train_all_json=./16k/train_all.json
audioset_eval_json=./16k/eval_19k.json
audioset_label=./16k/class_labels_indices.csv
audioset_train_weight=/checkpoint/berniehuang/mae/data/audioset/weight_train.csv
audioset_train_all_weight=./16k/weight_train_all.csv
dataset=audioset
